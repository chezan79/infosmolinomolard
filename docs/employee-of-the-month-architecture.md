...
Status: the secure monthly backend, public mobile voting interface, and protected employee-photo management workflow are implemented. Results management, notifications, and publication remain separate work.
